...
import (
	...
	"github.com/bloc-chain/bc-faucet/internal/chain"
	"github.com/bloc-chain/bc-faucet/internal/server"
)

var (
	appVersion = "v1.1.0"
	chainIDMap = map[string]int{"blocchain": 7690, "ropsten": 3, "rinkeby": 4, "goerli": 5, "kovan": 42}
